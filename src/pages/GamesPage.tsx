...
const GAMES = [
    {
        id: "antigravity",
        title: "Antigravity",
        desc: "High-speed momentum platformer with custom gravity physics. Master the flip, defy the grid.",
        icon: Zap,
        href: "https://prime-ai.fr/game",
    ...
    },
    {
        ...
        icon: Swords,
        href: "https://prime-ai.fr/games/arena",
    ...
    },
    {
        ...
        icon: Bot,
        href: "https://prime-ai.fr/games/werewolf",
