        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-min">
                ...
                <div className="flex flex-col gap-4">
                    {[
                        { label: 'REPOS MANAGED', value: '77', icon: Github, color: 'text-cyan-400', bg: 'bg-cyan-500/10', border: 'border-cyan-500/30' },
                        { label: 'UIs DEPLOYED', value: '125', icon: Monitor, color: 'text-violet-400', bg: 'bg-violet-500/10', border: 'border-violet-500/30' },
                        { label: 'CLI NODES', value: '12', icon: Terminal, color: 'text-fuchsia-400', bg: 'bg-fuchsia-500/10', border: 'border-fuchsia-500/30' }
                    ].map((stat, i) => (
